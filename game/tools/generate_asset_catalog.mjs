...
const PACKS = [
  ...
  { dir: 'third_party/opengameart',                  pack: 'OpenGameArt Monk Character',           license: 'CC0-1.0', attribution: false, author: 'CDmir (Collaborators: TinyWorlds)', source: 'https://opengameart.org/content/monk', use: 'Luther-Player-Charakter (höherwertiger Platzhalter)' },
